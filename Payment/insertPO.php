...
<head>
	...
	<script>
		...
		function createTable() {
			...
			var inputField = "<tr><td><input type='text' name='item[]' class='form-control' style='width:50%' required></td><td><input type='number' name='quantity[]' min='1' class='form-control' style='width:20%' required></td>" + "<td><input type='number' name='unitPrice[]' step='any' class='form-control' style='width:20%' required></td></tr>";
